...
class NeighList : protected Pointers {
 public:
  ...
  //------------zjq----------------// 2024-06-06
  int neigh_rbl;                   // Potential indicator function:0 for eam and 1 for eamrbm
  int *numneigh_core;              // core:# of J neighbors for each I atom
  int **firstneigh_core;           // core ptr to 1st J int value of each I atom
  int *numneigh_shell;             // shell:# of J neighbors for each I atom
  int **firstneigh_shell;          // shell ptr to 1st J int value of each I atom
  // 
  int *secondnumneigh_shell;          // shell:# of J neighbors for each I atom
  int **secondneigh_shell;         // shell ptr to 1st J int value of each I atom
  //-------------------------------//
  MyPage<int> *ipage_core;         // core_pages of neighbor indices
  MyPage<int> *ipage_shell;        // shell_pages of neighbor indices
  MyPage<int> *ipage_shell_second;        // shell_pages of neighbor indices
  //-------------------------------//
