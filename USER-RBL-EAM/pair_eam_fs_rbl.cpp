...
PairEAMFSRbl::PairEAMFSRbl(LAMMPS *lmp) : PairEAMRbl(lmp)
{
  one_coeff = 1;
  manybody_flag = 1;
}
...
void PairEAMFSRbl::coeff(int narg, char **arg)
{
...
void PairEAMFSRbl::read_file(char *filename)
{
  Fs *file = fs;
